...
<main class="main-content">
    <div class="container-fluid">
        <div class="mb-4">
            <h2>Edit Support Category: {{ $category->name }}</h2>
        </div>
        <div class="card">
            <div class="card-body">
                @if ($errors->any())
                ...
                @endif
                <form action="{{ route('support-categories.update', $category->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="icon" class="form-control" value="{{ old('icon', $category->icon) }}" placeholder="e.g., fas fa-rocket">
